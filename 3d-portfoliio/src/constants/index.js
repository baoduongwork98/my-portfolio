...
const words = ['Mobile (Android/iOS)', 'Web applications', 'Mini app'];
const counterItems = [
...
// const description = "I’ve worked with a variety of modern technologies including Flutter, .NET MAUI, Vue.js, ReactJS, and Node.js. My goal is to create products that not only work smoothly but also deliver an outstanding user experience. Feel free to explore some of the projects I’ve worked on!"
const description = "I’ve worked with a variety of modern technologies including Flutter, .NET MAUI, Vue.js, ReactJS, and Node.js."
export {
    showCases,
    words,
    description,
